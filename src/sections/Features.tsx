...
import avtar4 from "@/assets/images/avatar-owen-garcia.jpg";
            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-3">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 
                            outline outline-2
                            outline-transparent group-hover:outline-lime-400 outline-offset-4 group-hover:translate-y-1 transition-all duration-500">Shift</Key>
                            <Key className="outline outline-2
                            outline-transparent group-hover:outline-lime-400 outline-offset-4 group-hover:translate-y-1 transition-all duration-500 delay-150">Alt</Key>
                            <Key className="outline outline-2
                            outline-transparent group-hover:outline-lime-400 outline-offset-4 group-hover:translate-y-1 transition-all duration-500 delay-300">C</Key>
                        </div>
                    </FeatureCard>
                </div>
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        ...
                        >
                            <span className="bg-lime-400 text-neutral-950 size-5 rounded-full flex items-center justify-center text-xl group-hover:rotate-45 transition duration-500">
                                &#10038;
                            </span>
